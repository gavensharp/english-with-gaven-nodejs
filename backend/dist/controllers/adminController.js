...
async function getUserDetails(req, res) {
    try {
        ...
        const upcomingLessons = user.bookedLessons.filter((lesson) => lesson.status === "scheduled" &&
            new Date(lesson.startTime) > new Date());
        const completedLessons = user.bookedLessons.filter((lesson) => lesson.status === "completed");
        const cancelledLessons = user.bookedLessons.filter((lesson) => lesson.status === "cancelled");
        const userDetails = {
            ...user,
